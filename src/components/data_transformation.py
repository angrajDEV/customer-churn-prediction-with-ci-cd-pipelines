...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        '''
        this function is respoonsible for data transformation
        '''
        ...
        try:
            ...
            logging.info(f'categorical colunm : {categorical_columns}')
            logging.info(f'numerical colunm : {numerical_columns}')
